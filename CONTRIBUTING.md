Contributing to BitPal Core
============================

The BitPal Core project operates an open contributor model where anyone is
...
[good first issue](https://github.com/bitpal/bitpal/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22)
list or participate in a weekly [BitPal Core PR Review Club](https://bitpal.reviews/) meeting.

Communication Channels
----------------------

Most communication about BitPal Core development happens on IRC, in the
#bitpal-core-dev channel on Freenode. The easiest way to participate on IRC is
with the web client, [webchat.freenode.net](https://webchat.freenode.net/). Chat
history logs can be found
on [http://www.erisian.com.au/bitpal-core-dev/](http://www.erisian.com.au/bitpal-core-dev/)
and [http://gnusha.org/bitpal-core-dev/](http://gnusha.org/bitpal-core-dev/).

Discussion about code base improvements happens in GitHub issues and on pull
requests.

The developer
[mailing list](https://lists.linuxfoundation.org/mailman/listinfo/bitpal-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to bitpal-qt
...
[Translation Process](https://github.com/bitpal/bitpal/blob/master/doc/translation_process.md)
...
The following applies to code changes to the BitPal Core project (and related
projects such as libsecp256k1), and is not to be confused with overall BitPal
Network Protocol consensus changes.

Whether a pull request is merged into BitPal Core rests with the project merge
...
Patches that change BitPal consensus rules are considerably more involved than
...
Where a patch set proposes to change the BitPal consensus, it must have been
...
https://github.com/bitpal/bitpal/pull/16189).

Also see the [backport.py script](
https://github.com/bitpal-core/bitpal-maintainer-tools#backport).

Release Policy
--------------

The project leader is the release manager for each BitPal Core release.
