...
#ifndef BITPAL_RPC_PROTOCOL_H
#define BITPAL_RPC_PROTOCOL_H
...
enum RPCErrorCode
{
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in bitpald
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //!< BitPal is not connected
