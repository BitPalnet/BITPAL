...
static std::vector<RPCResult> MempoolEntryDescription() { return {
    ...
    RPCResult{RPCResult::Type::NUM, "size", "(DEPRECATED) same as vsize. Only returned if bitpald is started with -deprecatedrpc=size\n"
                        ...
                        {RPCResult::Type::OBJ, "scriptPubKey", "",
                            {
                                ...
                                {RPCResult::Type::ARR, "addresses", "array of bitpal addresses",
...
UniValue dumptxoutset(const JSONRPCRequest& request)
{
...

    {
        ...
        //
        // See discussion here:
        //   https://github.com/bitpal/bitpal/pull/15606#discussion_r274479369
        //
        LOCK(::cs_main);
