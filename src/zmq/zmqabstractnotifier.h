// Copyright (c) 2015-2018 The BitPal Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef BITPAL_ZMQ_ZMQABSTRACTNOTIFIER_H
#define BITPAL_ZMQ_ZMQABSTRACTNOTIFIER_H
...
#endif // BITPAL_ZMQ_ZMQABSTRACTNOTIFIER_H
