// Copyright (c) 2019-2020 The BitPal Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef BITPAL_UTIL_SETTINGS_H
#define BITPAL_UTIL_SETTINGS_H
...
//!       https://github.com/bitpal/bitpal/pull/15934/files#r337691812)
using SettingsValue = UniValue;

//! Stored bitpal settings. This struct combines settings from the command line
