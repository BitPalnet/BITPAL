...
#ifndef BITPAL_CRYPTO_CHACHA_POLY_AEAD_H
#define BITPAL_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@bitpal.
 *
 ...
 *
 * The chacha20-poly1305@bitpal combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@bitpal cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@bitpal are relatively fast in
...
#endif // BITPAL_CRYPTO_CHACHA_POLY_AEAD_H
