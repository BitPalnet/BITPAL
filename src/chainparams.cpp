...
public:
    CMainParams() {
        ...
        consensus.defaultAssumeValid = uint256S("0x000000000019d6689c085ae165831e934ff763ae46a2a6c172b3f1b60a8ce26f"); // 623950
        ...
        vSeeds.emplace_back("95.179.142.172");
        vSeeds.emplace_back("95.179.139.132");
...
public:
    CTestNetParams() {
        ...
        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x000000000933ea01ad0ee984209779baaec3ced90fa3f408719526f8d77f4943"); // 1692000
