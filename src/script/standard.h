...
#ifndef BITPAL_SCRIPT_STANDARD_H
#define BITPAL_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a bitpal address
 */
...
/**
 * Generate a BitPal scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // BITPAL_SCRIPT_STANDARD_H
