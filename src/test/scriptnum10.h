...
#ifndef BITPAL_TEST_SCRIPTNUM10_H
#define BITPAL_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from BitPal Core 0.10.0, for cross-comparison.
 */
public:
