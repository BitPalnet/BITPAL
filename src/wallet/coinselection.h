// Copyright (c) 2017-2018 The BitPal Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef BITPAL_WALLET_COINSELECTION_H
#define BITPAL_WALLET_COINSELECTION_H
...
#endif // BITPAL_WALLET_COINSELECTION_H
