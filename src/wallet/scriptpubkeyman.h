...
#ifndef BITPAL_WALLET_SCRIPTPUBKEYMAN_H
#define BITPAL_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The BitPal Core wallet was originally a collection of unrelated private
...
#endif // BITPAL_WALLET_SCRIPTPUBKEYMAN_H
