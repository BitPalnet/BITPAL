    ...
    platformStyle(_platformStyle)
{
    ...
    // normal bitpal address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying bitpal address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &BitPalAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
