...
//! Entry point for BitPalApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &BitPalApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for BitPalGUI tests.
void AppTests::guiTests(BitPalGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &BitPalGUI::consoleShown, this, &AppTests::consoleTests);
