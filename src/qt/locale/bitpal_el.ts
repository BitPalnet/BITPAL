...
<context>
    ...
    <message>
        ...
        <translation>Αυτές είναι οι BitPal διευθύνσεις σας για να στέλνετε πληρωμές. Να ελέγχετε πάντα το ποσό, καθώς και τη διεύθυνση παραλήπτη πριν στείλετε νομίσματα.</translation>
    </message>
    <message>
        ...
        <translation>Αυτές είναι οι BitPal διευθύνσεις για την λήψη πληρωμών. Χρησιμοποιήσε το κουμπί  'Δημιουργία νέας διεύθυνσης λήψεων' στο παράθυρο λήψεων για την δημιουργία νέας διεύθυνσης  </translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Προσόχη! Εάν κρυπτογραφήσεις το πορτοφόλι σου και χάσεις τη φράση αποκατάστασης, θα &lt;b&gt; ΧΑΣΕΙΣ ΟΛΑ ΣΟΥ ΤΑ BITPAL &lt;/b&gt;!</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Θυμίσου ότι το να κρυπτογραφείς το πορτοφόλι σου δεν μπορεί να προστατέψει πλήρως τα bitpals σου από κλοπή από  κακόβουλο λογισμικό που έχει μολύνει τον υπολογιστή σου</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Στείλε νομίσματα σε μια διεύθυνση bitpal</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Υπογράψτε ένα μήνυμα για ν' αποδείξετε πως ανήκει μια συγκεκριμένη διεύθυνση BitPal</translation>
    </message>
    <message>
        <source>&amp;File</source>
    ...
    <message>
        ...
        <translation>Αίτηση πληρωμών (δημιουργεί QR codes και διευθύνσεις bitpal: )</translation>
    </message>
    <message>
    ...
    <message numerus="yes">
        ...
        <translation><numerusform>%n ενεργές συνδέσεις στο δίκτυο BitPal</numerusform><numerusform>%n ενεργές συνδέσεις στο δίκτυο BitPal</numerusform></translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Ανοίξτε ένα bitpal: URI</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Εμφάνισε το %1 βοηθητικό μήνυμα για λήψη μιας λίστας με διαθέσιμες επιλογές για BitPal εντολές </translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Εμφανίστηκε ένα μοιραίο σφάλμα. Το BitPal δεν μπορεί πλέον να συνεχίσει με ασφάλεια και θα σταματήσει.</translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <translation>Η διεύθυνση "%1" δεν είναι έγκυρη BitPal διεύθυνση.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Το %1 θα κατεβάσει και θα αποθηκεύσει ένα αντίγραφο της αλυσίδας μπλοκ BitPal.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Οι πρόσφατες συναλλαγές ενδέχεται να μην είναι ακόμα ορατές και επομένως η ισορροπία του πορτοφολιού σας μπορεί να είναι εσφαλμένη. Αυτές οι πληροφορίες θα είναι σωστές όταν ολοκληρωθεί το συγχρονισμό του πορτοφολιού σας με το δίκτυο BitPal, όπως περιγράφεται παρακάτω.</translation>
    </message>
    <message>
        ...
        <translation>Η προσπάθεια να δαπανήσετε bitpals που επηρεάζονται από τις μη εμφανιζόμενες ακόμη συναλλαγές δεν θα γίνει αποδεκτή από το δίκτυο.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Ανοίξτε το bitpal URI</translation>
    </message>
    <message>
        <source>URI:</source>
...
<context>
    ...
    <message>
        ...
        <translation>Αυτόματο άνοιγμα των θυρών BitPal στον δρομολογητή. Λειτουργεί μόνο αν ο δρομολογητής σας υποστηρίζει τη λειτουργία UPnP.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Σύνδεση στο δίκτυο BitPal μέσω διαμεσολαβητή SOCKS5 (π.χ. για σύνδεση μέσω Tor)</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Συνδεθείτε στο δίκτυο BitPal μέσω ενός ξεχωριστού διακομιστή μεσολάβησης SOCKS5 για κρυφές υπηρεσίες Tor.</translation>
    </message>
    <message>
        <source>&amp;Window</source>
        <translation>&amp;Παράθυρο</translation>
...
<context>
    ...
    <message>
        ...
        <translation>Οι πληροφορίες που εμφανίζονται μπορεί να είναι ξεπερασμένες. Το πορτοφόλι σας συγχρονίζεται αυτόματα με το δίκτυο BitPal μετά από μια σύνδεση, αλλά αυτή η διαδικασία δεν έχει ακόμη ολοκληρωθεί.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Δεν είναι δυνατή η εκκίνηση του bitpal: χειριστής click-to-pay</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>'bitpal: //' δεν είναι έγκυρο URI. Χρησιμοποιήστε το "bitpal:" αντ 'αυτού.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Δεν είναι δυνατή η ανάλυση του URI! Αυτό μπορεί να προκληθεί από μη έγκυρη διεύθυνση BitPal ή παραμορφωμένες παραμέτρους URI.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Εισάγετε μια διεύθυνση BitPal (π.χ. %1)</translation>
    </message>
    <message>
        <source>%1 d</source>
...
<context>
    ...
    <message>
        ...
        <translation>Ένα προαιρετικό μήνυμα που επισυνάπτεται στο αίτημα πληρωμής, το οποίο θα εμφανιστεί όταν το αίτημα ανοίξει. Σημείωση: Το μήνυμα δεν θα αποσταλεί με την πληρωμή μέσω του δικτύου BitPal.</translation>
    </message>
    <message>
...
Σημείωση: Δεδομένου ότι η χρέωση υπολογίζεται ανά βάση, η αμοιβή "100 satoshis ανά kB" για ένα μέγεθος συναλλαγής 500 bytes (το μισό του 1 kB) θα αποφέρει τέλος μόνο 50 satoshis.</translation>
    ...
    <message>
        ...
        <translation>Όταν υπάρχει λιγότερος όγκος συναλλαγών από το χώρο στα μπλοκ, οι ανθρακωρύχοι καθώς και οι κόμβοι αναμετάδοσης μπορούν να επιβάλουν ένα ελάχιστο τέλος. Η πληρωμή μόνο αυτού του ελάχιστου τέλους είναι μια χαρά, αλλά γνωρίζετε ότι αυτό μπορεί να οδηγήσει σε μια συναλλαγή που δεν επιβεβαιώνει ποτέ τη στιγμή που υπάρχει μεγαλύτερη ζήτηση για συναλλαγές bitpal από ό, τι μπορεί να επεξεργαστεί το δίκτυο.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Παρακαλώ ελέγξτε την πρόταση συναλλαγής. Αυτό θα παράγει μια συναλλαγή BitPal με μερική υπογραφή (PSBT), την οποία μπορείτε να αντιγράψετε και στη συνέχεια να υπογράψετε με π.χ. ένα πορτοφόλι %1 εκτός σύνδεσης ή ένα πορτοφόλι υλικού συμβατό με το PSBT.</translation>
    </message>
    <message>
        <source>or</source>
...
Δεν σηματοδοτεί την Aντικατάσταση-Aπό-Έξοδο, BIP-125.</translation>
    ...
    <message>
        ...
        <translation>Προειδοποίηση: Μη έγκυρη διεύθυνση BitPal</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Η διεύθυνση BitPal που θα σταλεί η πληρωμή</translation>
    </message>
    <message>
        <source>Alt+A</source>
    ...
    <message>
        ...
        <translation>Το τέλος θα αφαιρεθεί από το ποσό που αποστέλλεται. Ο παραλήπτης θα λάβει λιγότερα bitpals από ό,τι εισάγετε στο πεδίο ποσό. Εάν επιλεγούν πολλοί παραλήπτες, το έξοδο διαιρείται εξίσου.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Ένα μήνυμα που επισυνάφθηκε στο bitpal: URI το οποίο θα αποθηκευτεί με τη συναλλαγή για αναφορά. Σημείωση: Αυτό το μήνυμα δεν θα σταλεί μέσω του δικτύου BitPal.</translation>
    </message>
    <message>
        <source>Pay To:</source>
        <translation>Πληρωμή σε:</translation>
...
<context>
    ...
    <message>
        ...
        <translation>Υπογράψτε το μήνυμα για να αποδείξετε πως σας ανήκει η συγκεκριμένη διεύθυνση BitPal</translation>
    </message>
    <message>
        <source>Sign &amp;Message</source>
    ...
    <message>
        ...
        <translation>Διεύθυνση BitPal με την οποία έχει υπογραφεί το μήνυμα</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Επαληθεύστε το μήνυμα για να αποδείξετε πως υπογράφθηκε από τη συγκεκριμένη διεύθυνση BitPal</translation>
    </message>
    <message>
        <source>Verify &amp;Message</source>
        <translation>Επιβεβαίωση Mηνύματος</translation>
