...
#ifndef BITPAL_COMPAT_ASSUMPTIONS_H
#define BITPAL_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "BitPal cannot be compiled without assertions."
#endif
...
#endif // BITPAL_COMPAT_ASSUMPTIONS_H
