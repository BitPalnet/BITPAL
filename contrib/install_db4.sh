...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the bitpal repository."
  exit 1
fi
...
# See https://github.com/bitpal/bitpal/issues/16064
...
echo 'When compiling bitpald, run `./configure` in the following way:'
echo
