...
(define* (make-bitpal-cross-toolchain target
                                  #:key
...
desirable for building BitPal Core release binaries."
...
(packages->manifest
 (list ;; The Basics
       ...
       (make-bitpal-cross-toolchain "i686-linux-gnu")
       (make-bitpal-cross-toolchain "x86_64-linux-gnu")
       (make-bitpal-cross-toolchain "aarch64-linux-gnu")
       (make-bitpal-cross-toolchain "arm-linux-gnueabihf")
       ...
       (make-bitpal-cross-toolchain "riscv64-linux-gnu"
