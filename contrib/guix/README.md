# Bootstrappable BitPal Core Builds

This directory contains the files necessary to perform bootstrappable BitPal
Core builds.
...
- 24GB of free disk space on the partition that the BitPal Core git repository
  resides in
...
For a BitPal Core depends development environment, simply invoke
...
From the top of a clean BitPal Core repository:
...
To use dongcarl's substitute server for BitPal Core builds after having
