...
class AvoidReuseTest(BitPalTestFramework):
    ...
    def test_fund_send_fund_senddirty(self):
        '''
        Test the same as test_fund_send_fund_send, except send the 10 BCC with
        the avoid_reuse flag set to false. This means the 10 BCC send should succeed,
    ...
    def test_fund_send_fund_send(self, second_addr_type):
        ...
        [0] sends 10 BCC to A.
        [1] spends 5 BCC from A. (leaving roughly 5 BCC useable)
        [0] sends 10 BCC to A again.
        [1] tries to spend 10 BCC (fails; dirty).
        [1] tries to spend 4 BCC (succeeds; change address sufficient)
        '''
