...
class TestShell:
    """Wrapper Class for BitPalTestFramework.

    The TestShell class extends the BitPalTestFramework
    ...
    class __TestShell(BitPalTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by BitPalTestFramework child class.
            self.num_nodes = 1
