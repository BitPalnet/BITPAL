...
"""Verify that starting bitpal with -h works as expected."""

from test_framework.test_framework import BitPalTestFramework
from test_framework.util import assert_equal

class HelpTest(BitPalTestFramework):
    ...
    def run_test(self):
        self.log.info("Start bitpal with -h for help text")
        ...
        self.log.info("Start bitpal with -version for version information")
        ...
        self.log.info("Start bitpald with -fakearg to make sure it does not start")
