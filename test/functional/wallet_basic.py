...
class WalletTest(BitPalTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 BCC from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 BCC with subtract fee from amount
        ...
        # Sendmany 10 BCC with subtract fee from amount
        ...
        # This will raise an exception for attempting to get the private key of an invalid BitPal address
        assert_raises_rpc_error(-5, "Invalid BitPal address", self.nodes[0].dumpprivkey, "invalid")

        # This will raise an exception for attempting to set a label for an invalid BitPal address
        assert_raises_rpc_error(-5, "Invalid BitPal address", self.nodes[0].setlabel, "invalid address", "label")

        # This will raise an exception for importing an invalid address
        assert_raises_rpc_error(-5, "Invalid BitPal address or script", self.nodes[0].importaddress, "invalid")
        ...
        maintenance = [
            ...
            '-zapwallettxes=1',
            '-zapwallettxes=2',
            # disabled until issue is fixed: https://github.com/bitpal/bitpal/issues/7463
            # '-salvagewallet',
        ]
        chainlimit = 6
