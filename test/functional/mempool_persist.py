...
By default, bitpald will dump mempool on shutdown and
...
class MempoolPersistTest(BitPalTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent bitpald from writing mempool.dat to disk. Verify that `savemempool` fails")
