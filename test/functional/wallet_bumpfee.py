...
# Fee rates (in BCC per 1000 vbytes)
...
class BumpFeeTest(BitPalTestFramework):
...
def test_dust_to_fee(self, rbf_node, dest_address):
    ...
    # The DER formatting used by BitPal to serialize ECDSA signatures means that signatures can have a
    ...
    # Bump with fee_rate of 0.00350250 BCC per 1000 vbytes to create dust.
    # Expected fee is 141 vbytes * fee_rate 0.00350250 BCC / 1000 vbytes = 0.00049385 BCC.
    # or occasionally 140 vbytes * fee_rate 0.00350250 BCC / 1000 vbytes = 0.00049035 BCC.
    # Dust should be dropped to the fee, so actual bump fee is 0.00050000 BCC.
...
def test_maxtxfee_fails(self, rbf_node, dest_address):
    ...
    # expected bump fee of 141 vbytes * 0.00200000 BCC / 1000 vbytes = 0.00002820 BCC
