...
class P2PPermissionsTests(BitPalTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].bitpalconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].bitpalconf, 'w', encoding="utf8") as f:
            f.write(newText)
