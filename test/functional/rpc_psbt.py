...
class PSBTTest(BitPalTestFramework):
    ...
    def run_test(self):
        # Create and fund a raw tx for sending 10 BCC
        ...
        # feeRate of 0.1 BCC / KB produces a total fee slightly below -maxtxfee (~0.05280000):
        ...
        # feeRate of 10 BCC / KB produces a total fee well above -maxtxfee
