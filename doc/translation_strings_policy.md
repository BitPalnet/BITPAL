...
This document provides guidelines for internationalization of the BitPal Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `bitpal_en.ts` remains unchanged.
