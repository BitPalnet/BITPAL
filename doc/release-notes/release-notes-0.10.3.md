BitPal Core version 0.10.3 is now available from:

  <https://www.bit-pal.net/bin/bitpal-core-0.10.3/>
...
(see https://github.com/bitpal/bitpal/pull/6793, as well as the 0.11.0
