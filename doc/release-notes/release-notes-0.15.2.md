BitPal Core version *0.15.2* is now available from:

  <https://www.bit-pal.net/bin/bitpal-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in bitpal-tx (TheBlueMatt)
