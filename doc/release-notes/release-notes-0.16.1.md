BitPal Core version 0.16.1 is now available from:

  <https://www.bit-pal.net/bin/bitpal-core-0.16.1/>
...
- #12843 `df38b13` Test starting bitpald with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure bitpald processes are cleaned up when tests end (sdaftuar)
