BitPal version 0.5.4 is now available for download at:
http://sourceforge.net/projects/bitpal/files/BitPal/bitpal-0.5.4/
...
http://gitorious.org/bitpal/bitpald-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix BitPal-Qt notifications under Growl 1.3.
Increase required age of BitPal-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxBitPal properly when installing BitPal-Qt over it. (Windows)
