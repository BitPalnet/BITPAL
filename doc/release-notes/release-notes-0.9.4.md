BitPal Core version 0.9.4 is now available from:

  https://www.bit-pal.net/bin/0.9.4/
...
this update is incompatible with the BitPal system and could lead to consensus
forks.

BitPal Core released binaries from https://bitpal.com are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~bitpal/+archive/ubuntu/bitpal
- A third-party or self-compiled BitPal Core

upgrade to BitPal Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
