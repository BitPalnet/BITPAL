BitPal Core version 0.10.4 is now available from:

  <https://www.bit-pal.net/bin/bitpal-core-0.10.4/>
...
- #6953 `43c2789` Split bitpal-tx into its own package
- #6953 `dfe0d4d` Include bitpal-tx binary on Debian/Ubuntu
