BitPal-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/bitpal/files/BitPal/bitpal-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the BitPal
...
New/changed settings (command-line or bitpal.conf file)
--------------------------------------------------------
