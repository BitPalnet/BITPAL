BitPal Core version 0.13.2 is now available from:

  <https://www.bit-pal.net/bin/bitpal-core-0.13.2/>
...
- #8908 `4a974b2` Update bitpal-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow bitpal-tx to create v2 transactions (btcdrak)
