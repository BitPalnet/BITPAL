...
BitPal Core version 0.19.1 is now available from:

  <https://www.bit-pal.net/bin/bitpal-core-0.19.1/>
...
From BitPal Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as BitPal Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, BitPal Core does not yet change appearance when
...
- #17488 fix "bitpald already running" warnings on macOS (fanquake)
...
[Transifex](https://www.transifex.com/bitpal/bitpal/).
