...
By default, BitPal Core allows up to 125 connections to different peers, 10 of
...
limits are tiny. Keep in mind that bitpal's trustless model works best if you are
